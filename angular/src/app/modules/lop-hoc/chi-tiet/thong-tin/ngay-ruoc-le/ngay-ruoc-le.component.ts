...
@Component({
  selector: 'app-ngay-ruoc-le',
  templateUrl: './ngay-ruoc-le.component.html',
  styleUrls: ['./ngay-ruoc-le.component.scss']
})
export class NgayRuocLeComponent implements OnDestroy {
  @Output() updateInfo = new EventEmitter();
  private urlAPI = environment.apiURL + '/tai-khoan/ngay-ruoc-le';
